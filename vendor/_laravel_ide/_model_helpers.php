...
namespace App\Models {
     ...
     * @property string $konsentrasi_keahlian
     * @property string $kelas
     * @property mixed $nis_nisn
     * @property string $nama
     * @property int $id
     * @method static \Illuminate\Database\Eloquent\Builder<Pengguna>|Pengguna whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Pengguna>|Pengguna whereNama($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Pengguna>|Pengguna whereNisNisn($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Pengguna>|Pengguna whereKelas($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Pengguna>|Pengguna whereKonsentrasiKeahlian($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Pengguna>|Pengguna whereJenisKelamin($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Pengguna>|Pengguna whereStatus($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Pengguna>|Pengguna whereRole($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Pengguna>|Pengguna whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Pengguna>|Pengguna whereUpdatedAt($value)
